#!/bin/bash
# Adapted from https://github.com/mlcommons/inference/blob/master/vision/classification_and_detection/tools/make_fake_imagenet.sh

opt=-q

installPath=$(realpath $1)/fake_imagenet

mkdir -p $installPath/val
