...
def createReq(params, cubinPath, mode='direct'):
    ...
    # kernel 0
    output_size = 8192
    nodes["n0"] = kaas.bufferSpec('n0', output_size, const=True, ephemeral=True)
    arguments = [(nodes["n0"], 't'), (nodes[94], 'i')]
    shapes = [(2, 1, 1), (1024, 1, 1)]
    ...
    arguments = [(nodes["n0"], 'i'), (nodes[112], 'i'), (nodes[114], 't'), (nodes[113], 'i')]
    ...
    # kernel 0
    output_size = 4
    nodes["n1"] = kaas.bufferSpec('n1', output_size, const=True, ephemeral=True)
    arguments = [(nodes[114], 'i'), (nodes["n1"], 't')]
    shapes = [(1, 1, 1), (32, 32, 1)]
    ...
    arguments = [(nodes[117], 't'), (nodes[114], 'i'), (nodes["n1"], 'i')]
    ...
    # kernel 0
    output_size = 4
    nodes["n2"] = kaas.bufferSpec('n2', output_size, const=True, ephemeral=True)
    arguments = [(nodes[117], 'i'), (nodes["n2"], 't')]
    shapes = [(1, 1, 1), (32, 32, 1)]
    kerns.append(makeKern('fused_sum_kernel0', path, shapes, arguments))

    # 171. fused_divide
    # kernel 0
    arguments = [(nodes[114], 'o'), (nodes[117], 'i'), (nodes["n2"], 'i')]
    shapes = [(1, 1, 1), (1001, 1, 1)]
